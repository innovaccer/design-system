...
const SaraDisabledBottom = (props: SaraIconType) => {
  ...
  return (
    ...
    >
      <mask id="path-1-outside-1_2094_5854" maskUnits="userSpaceOnUse" x="1" y="0" width="15" height="15" fill="black">
      ...
      <defs>
        ...
        >
          ...
          <stop offset="1" stopColor="#F4A4C9" />
        </linearGradient>
      </defs>
    </svg>
  );
