...
const filterRequired = (props: Record<string, any>) => Object.keys(props)
  .reduce((out, curr) => {
...
const iterateComb = (requiredComb: Record<string, any>[], optionalComb: Record<string, any>[], testFunc?: ((props: Record<string, any>) => void)): Record<string, any>[] => {
...
const iterateMapper = (Mapper: Record<string, any>, testFunc?: ((props: Record<string, any>) => void)): Record<string, any>[] | void => {
...
export const filterUndefined = (props: Record<string, any>) => Object.keys(props)
...
export const testMessageHelper = (attr: Record<string, any>) => `
  ${Object.keys(attr).map(k => `${k}: ${JSON.stringify(attr[k], JSONStringifyHelper)}`).join(', ')}
`;
