...
describe('Input component comprehensive behavior tests', () => {
  ...
  describe('Action icon functionality', () => {
  ...
  describe('Info tooltip functionality', () => {
  ...
  describe('CSS State Behaviors', () => {
    ...
    it('applies focus-within state correctly', () => {
    ...
    it('applies error state focus behavior correctly', () => {
    ...
    it('applies tiny size icon styling correctly', () => {
      ...
      expect(wrapper).toHaveClass('Input-size--tiny');
      expect(leftIcon).toBeInTheDocument();
      expect(leftIcon).toHaveClass('Input-iconLeft--tiny');
    });
  });

  describe('Icon Type and States', () => {
  ...
  describe('Tiny Input Icon Support', () => {
    ...
    it('applies tiny-specific icon CSS classes', () => {
    ...
    it('applies Input-size--tiny class when tiny size has icon', () => {
    ...
    it('does not apply Input-size--tiny class when tiny size without icon', () => {
      const { getByTestId } = render(<Input name="test" size="tiny" />);

      const wrapper = getByTestId('DesignSystem-InputWrapper');
      expect(wrapper).not.toHaveClass('Input-size--tiny');
    });
    ...
    it('works with different icon types for tiny size', () => {
    ...
    it('works with tiny size in different states', () => {
      ...
      expect(errorIcon).toHaveClass('Input-iconLeft--tiny');
      ...
      expect(disabledIcon).toHaveClass('Input-iconLeft--tiny');
    });

    it('supports clear functionality with tiny icons', () => {
      const onClearMock = jest.fn();
      const { getByTestId, container } = render(
    ...
    it('supports action icons with tiny icons', () => {
      const customActionIcon = <Input.ActionButton name="custom" onClick={jest.fn()} />;
      const { getByTestId, container } = render(
  ...
  describe('Right Icon Wrapper Interactions', () => {
  ...
  describe('Input Size and Line Height Variations', () => {
    it('applies correct input classes for tiny size', () => {
    ...
    it('applies correct input classes for regular size', () => {
    ...
    it('applies correct input classes for large size', () => {
