...
describe('selection range is set correctly on input type change', () => {
  it('through Action Button', () => {
    ...
    (input as HTMLInputElement).setSelectionRange = FunctionValue;
    input.focus = FunctionValue;

    fireEvent.click(actionButton);

    expect((input as HTMLInputElement).setSelectionRange).toHaveBeenCalledWith(
      defaultValue.length,
      defaultValue.length
    );
