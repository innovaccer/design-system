  ...
  return (
    <div className="Row">
      <div className="mr-9 mb-8 w-25">
        <Input name="input" onChange={action('on-change')} icon={icon} />
        <br />
      ...
      <div className="mr-9 mb-8 w-25">
        <Input name="input" onChange={action('on-change')} error={true} icon={icon} />
        <br />
        <Text weight="strong">Error</Text>
      </div>
      <div className="mr-9 mb-8 w-25">
        <Input name="input" value="Value" disabled={true} icon={icon} />
        <br />
