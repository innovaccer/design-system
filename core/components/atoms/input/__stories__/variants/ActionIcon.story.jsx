...
export const actionIcon = () => {
  const customIcon = <Input.ActionButton name="event" onClick={action('Custom action icon')} className="p-3" />;
...
const customCode = `() => {
  const actionIcon = (
    <Input.ActionButton name="event" onClick={() => console.log("Custom action icon")} className="p-3" />
  );
