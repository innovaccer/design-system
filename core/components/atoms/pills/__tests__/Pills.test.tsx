...
const appearances: Appearance[] = ['primary', 'alert', 'warning', 'success', 'accent1',
  'accent2', 'accent3', 'accent4']; const BooleanValue = [true, false];
...
describe('Pills component', () => {
  ...
  it('renders children', () => {
    const { getByTestId } = render(<Pills subtle={true} appearance="secondary">{'Pills'}</Pills>);
  ...
  describe('Pill component tagName', () => {
    ...
    it('renders tagName', () => {
      const { getByTestId } = render(<Pills subtle={true} appearance="secondary">{'Design System'}</Pills>);
  ...
  describe('Pills component with prop:subtle', () => {
    ...
    appearances.forEach(appearance => {
      it(`should have the Badge--subtle-${appearance} class when appearance=${appearance} `, () => {
        const { getByTestId } = render(<Pills appearance={appearance} subtle={true}>{'Design'}</Pills>);
