...
import data from '@/components/organisms/grid/__stories__/_common_/expandedData.ts';
...
export default {
  title: 'Components/Table/Nesting/Without Trigger',
  component: Table,
  parameters: {
    docs: {
      docPage: {
        customCode,
        title: 'Nesting in Table Without Trigger',
        props: {
