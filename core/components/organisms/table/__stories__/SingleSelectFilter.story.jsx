  ...
  const schema = [
    {
      ...
      filters: [
        ...
        { label: 'Flu Vaccination', value: 'Flu Vaccination' },
        { label: 'Well-child Visit', value: 'Well-child Visit' },
        { label: 'Annual wellness Visit', value: 'Annual wellness Visit' },
      ],
  ...
  const schema = [
    {
      ...
      onFilterChange: (a, filters) => {
        ...
        for (const filter of filters) {
          if (a.name === filter || filter === 'All') return true;
        }
        return false;
      },
    },
...
export default {
  title: 'Components/Table/Single Select Filter',
  component: Table,
  parameters: {
    docs: {
      docPage: {
        customCode,
        title: 'Single Select Filter In Table',
        props: {
