...
describe('Navigation component', () => {
  ...
  it('renders vertical nav when vertical type is passed', () => {
    ...
    expect(getAllByTestId('DesignSystem-VerticalNavigation--MenuWrapper')).toBeTruthy();
  });
});
...
describe('VerticalNavigation component', () => {
  it('render vertical nav when subMenu  is passed and menu tab is active', () => {
    ...
    expect(getAllByTestId('DesignSystem-SubMenuIcon')[0]).toHaveTextContent('keyboard_arrow_up_round');
    expect(getAllByTestId('DesignSystem-SubMenuIcon')[1]).toHaveTextContent('keyboard_arrow_down_round');
  });
  ...
  it('render vertical nav when subMenu  is not passed and menu tab is active', () => {
    ...
    expect(getAllByTestId('DesignSystem-VerticalNavigation--MenuItem')[0]).toHaveClass('Navigation-menu--active');
  });
  ...
  it('render vertical nav menu is expanded and rounded', () => {
    ...
    expect(getAllByTestId('DesignSystem-VerticalNavigation--MenuItem')[0]).toHaveClass('Navigation-menu--rounded');
  });

  it('render vertical nav menu is has icon', () => {
    const { getByTestId } = render(<Navigation menus={menus} type="vertical" />);
    expect(getByTestId('DesignSystem-VerticalNavigation--MenuIcon')).toHaveClass('Navigation-menuIcon');
  });
  ...
  it('render vertical nav menu is has icon and menu is active', () => {
    ...
    expect(getByTestId('DesignSystem-VerticalNavigation--MenuIcon')).toHaveClass('Navigation-menuIcon--active');
  });
});
...
describe('Vertical Navigation component prop: onClick', () => {
  it('renders vertical nav  component with  onClick without submenu ', () => {
    ...
    const menuClicked = getAllByTestId('DesignSystem-VerticalNavigation--MenuItem')[0];
  ...
  it('renders vertical nav  component with onClick with subMenu and expanded false', () => {
    ...
    const menuClicked = getAllByTestId('DesignSystem-VerticalNavigation--MenuItem')[2];
    fireEvent.click(menuClicked);
  ...
  it('renders vertical nav  component with onClick  on Submenu ', () => {
    ...
    const menuClicked = getAllByTestId('DesignSystem-VerticalNavigation--SubMenu')[0];
    fireEvent.click(menuClicked);
