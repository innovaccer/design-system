...
// CSF format story - Outlined variant
      ...
      {sizeConfigs.map((config, key) => {
        return (
          <Column key={key} size={4}>
            <Label className="mb-3">{config.label} Outlined Select</Label>
            <Select
              styleType="outlined"
...
export default {
  title: 'Components/Select/StyleType/Outlined',
  component: Select,
  subcomponents: {
  ...
  parameters: {
    docs: {
      docPage: {
        title: 'Select (styleType: Outlined)',
        customCode,
      },
    },
  },
