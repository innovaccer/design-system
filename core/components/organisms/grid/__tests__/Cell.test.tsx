...
import { Cell } from '@/components/organisms/grid/Cell';
...
const renderHeadCell = (props = {}, context = {}) => customRender(
  <Cell
    isHead={true}
    schema={schema}
    colIndex={0}
...
describe('Cell component', () => {
  it('renders default', () => {
    const jestObj = renderBodyCell({ isHead: undefined });
    const { queryByTestId } = jestObj;
