...
const InputMask = React.forwardRef<HTMLInputElement, InputMaskProps>((props, forwardRef) => {
  ...
  const onChangeHandler = React.useCallback(
    (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (inputVal === undefined) {
        console.error('inputVal is undefined');
        return;
      }
  ...
  // const debouncedOnChangeHandler = debounce(500, (e: React.ChangeEvent<HTMLInputElement>) => {
  //   const event = {
  //     target: e.target,
  ...
  const debouncedOnChangeHandler = debounce(500, (e: React.ChangeEvent<HTMLInputElement>) => {
    e.persist(); // Persist the event to prevent React from reusing it
    onChangeHandler(e);
  });
