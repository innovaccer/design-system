...
export const flex = () => {
  ...
  return (
    <div>
      ...
      <Text className="mb-4">Here are examples of these flex utilities in action:</Text>
      ...
      <div className="mb-6">
        <div className="d-flex flex-row bg-secondary-lightest border p-4 gap-3 mb-4">
        ...
        <div className="d-flex flex-row-reverse bg-secondary-lightest border p-4 gap-3">
          <Text appearance="default" className="p-3 bg-secondary-lightest border">
            Flex item 1
          </Text>
          <Text appearance="default" className="p-3 bg-secondary-lightest border">
      ...
      <div className="mb-8 bg-secondary-lightest p-3 rounded-10 font-size-xs">
        <pre className="m-0">
          {[
            '<div className="d-flex flex-row bg-secondary-lightest border p-4 gap-3">',
      ...
      <div className="mb-6">
        <div className="d-flex flex-column bg-secondary-lightest border p-4 gap-3 mb-4">
          <Text appearance="default" className="p-3 bg-secondary-lightest border">
            Flex item 1
          </Text>
          <Text appearance="default" className="p-3 bg-secondary-lightest border">
        ...
        <div className="d-flex flex-column-reverse bg-secondary-lightest border p-4 gap-3">
          <Text appearance="default" className="p-3 bg-secondary-lightest border">
            Flex item 1
          </Text>
          <Text appearance="default" className="p-3 bg-secondary-lightest border">
      ...
      <div className="mb-8 bg-secondary-lightest p-3 rounded-10 font-size-xs">
        <pre className="m-0">
          {[
            '<div className="d-flex flex-column bg-secondary-lightest border p-4 gap-3">',
            '  <Text appearance="default" className="p-3 bg-secondary-lightest border">Flex item 1</Text>',
            '  <Text appearance="default" className="p-3 bg-secondary-lightest border">Flex item 2</Text>',
            '  <Text appearance="default" className="p-3 bg-secondary-lightest border">Flex item 3</Text>',
            '</div>',
      ...
      <div className="mb-6">
        <div className="d-flex gap-3 bg-secondary-lightest border p-4">
          <Text appearance="default" className="p-3 bg-secondary-lightest border">
            Flex item with gap
          </Text>
          <Text appearance="default" className="p-3 bg-secondary-lightest border">
      ...
      <div className="mb-8 bg-secondary-lightest p-3 rounded-10 font-size-xs">
        <pre className="m-0">
          {[
            '<div className="d-flex gap-3 bg-secondary-lightest border p-4">',
            '  <Text appearance="default" className="p-3 bg-secondary-lightest border">Flex item with gap</Text>',
            '  <Text appearance="default" className="p-3 bg-secondary-lightest border">Flex item with gap</Text>',
            '  <Text appearance="default" className="p-3 bg-secondary-lightest border">Flex item with gap</Text>',
            '</div>',
          ].join('\n')}
        </pre>
        <div className="font-size-xs mt-2">{'/* gap-3 uses var(--spacing-10) */'}</div>
      </div>
      <Heading size="s" className="mb-3">
        Row and Column Gap
      </Heading>
      <Text appearance="subtle" className="mb-4">
        Control spacing by axis.
      </Text>
      <div className="mb-6">
        <div className="d-flex flex-wrap row-gap-3 column-gap-4 bg-secondary-lightest border p-4">
          <Text appearance="default" className="p-2 bg-secondary-lightest border">
            Item with row and column gap
          </Text>
          <Text appearance="default" className="p-2 bg-secondary-lightest border">
            Item with row and column gap
          </Text>
      ...
      <div className="mb-8 bg-secondary-lightest p-3 rounded-10 font-size-xs">
        <pre className="m-0">
          {[
            '<div className="d-flex flex-wrap row-gap-3 column-gap-4 bg-secondary-lightest border p-4">',
            '  <Text className="p-2 bg-secondary-lightest border">Item with row and column gap</Text>',
            '  <Text className="p-2 bg-secondary-lightest border">Item with row and column gap</Text>',
            '  <Text className="p-2 bg-secondary-lightest border">Item with row and column gap</Text>',
            '  <Text className="p-2 bg-secondary-lightest border">Item with row and column gap</Text>',
            '  <Text className="p-2 bg-secondary-lightest border">Item with row and column gap</Text>',
        ...
        <Text appearance="subtle" className="font-size-xs mt-2">
          {'/* row-gap-3 uses var(--spacing-10), column-gap-4 uses var(--spacing-20) */'}
        </Text>
      </div>
