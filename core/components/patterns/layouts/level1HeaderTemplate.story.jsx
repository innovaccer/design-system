...
import { Row, Column, PageHeader, Navigation, Breadcrumbs, Button, Badge } from '@/index';
...
export const level1HeaderTemplate = () => {
  ...
  const options = {
    navigationPosition,
    title,
    navigation: <Navigation menus={navigationData} onClick={(menu) => action(menu)} active={{ name: 'menu_1' }} />,
    actions: (
      <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
        <Button appearance="primary">Primary</Button>
      </div>
    ),
    breadcrumbs: <Breadcrumbs list={breadcrumbData} onClick={(link) => action(link)} />,
