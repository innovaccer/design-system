...
export const stepperForm = () => {
  ...
  class StepperForm extends Component {
    ...
    onSubmit(event) {
      ...
      action(this.state.configuration);
      return false;
    }
    ...
    renderButton() {
      ...
      return (
        <Button appearance="primary" onClick={this.onClickNext}>
          Next
        </Button>
      );
    }
            ...
            <form onSubmit={this.onSubmit}>
              ...
              <div className={value !== 'Define_Input_Output' ? 'd-none' : ''}>
                ...
                <div className="w-25 mt-6">
                  ...
                  <Select width="100%" onSelect={(option) => this.onChangeOutput(option.value, 'retention')}>
                    <Select.List>
                      {options.map((item, key) => {
                        return (
                          <Select.Option key={key} option={{ label: item.label, value: item.value }}>
                  ...
                  <Label className="mt-6" withInput={true}>
                    Visibility Clarification
                  </Label>
                  <Select width="100%" onSelect={(option) => this.onChangeOutput(option.value, 'clarification')}>
                    <Select.List>
                      {options.map((item, key) => {
                        return (
                          <Select.Option key={key} option={{ label: item.label, value: item.value }}>
              ...
              <div className={value !== 'Add_Configuration' ? 'd-none' : ''}>
                ...
                <Label className="mt-6" withInput={true} required>
                  Retention
                </Label>
