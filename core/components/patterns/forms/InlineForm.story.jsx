        ...
        <div className="w-100">
          <Card className="px-6 py-6">
            <form onSubmit={this.onSubmit}>
              <div className="d-flex flex-wrap">
                ...
                <div className="mr-6 mb-6">
                  ...
                  <div className="d-flex">
                    <Button className="mr-3" onClick={() => this.onChange('Male', 'gender')}>
                      Male
                    </Button>
                    <Button className="mr-3" onClick={() => this.onChange('Female', 'gender')}>
                      Female
                    </Button>
                    <Button className="mr-3" onClick={() => this.onChange('Other', 'gender')}>
                      Other
                    </Button>
              ...
              <Button disabled={this.state.searchDisabled} appearance="primary" type="submit">
                Search
              </Button>
            </form>
          </Card>
