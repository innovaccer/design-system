...
export const verificationCodeInput = () => {
  class VerificationCodeInputCard extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
      ...
      if (isTimerStarted && (timer !== prevState.time || prevState.isTimerStarted !== isTimerStarted)) {
        if (timer > 0) {
          setTimeout(() => {
            this.setState({
              timer: timer - 1,
          ...
          <div className="w-50">
            {(value || error) && (
              <Message
                ...
                description={
                  error
                    ? 'The code that you have entered is invalid or incorrect. Try again.'
            ...
            <Card className="py-6 px-6">
              ...
              <Label withInput={true} className="mt-7">
                Verification code
              </Label>
              <div className="d-flex align-items-center">
                <VerificationCodeInput fields={6} onComplete={this.onCompleteHandler} disabled={loading || !!value} />
