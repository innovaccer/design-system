        ...
        <div className="w-75">
          <Card className="px-7 py-6">
            ...
            <div className="my-6 pt-6" style={{ borderTop: 'var(--border-width-2-5) solid var(--secondary-light)' }}>
              ...
              />
              <Paragraph appearance="subtle">
                Limit to <b>{this.state.time} hours</b> per day per Care Manager
              </Paragraph>
              <Slider
                className="mt-6 mb-7"
              ...
              />
              <Paragraph appearance="subtle">
                Allocated Budget: <b>\${this.state.budget}K</b>{' '}
              </Paragraph>
            </div>
            <div
            ...
            >
              <Button appearance="basic" className="mr-4">
                Cancel
              </Button>
