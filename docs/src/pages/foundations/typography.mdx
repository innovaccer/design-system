...
<b> Note: </b>To achieve barrier-free design, we follow the WCAG standard, which maintains an AA level of contrast ratio, i.e. 4.5:1 or more between body text, title, and background color.
...
![Using different colors](./images/typography-2.png)
<Caption>Contrast between background and text according to AA level</Caption>
