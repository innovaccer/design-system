...
<table style={{ width: '100%' }}>
  <tbody>
    <tr>
      <th style={{ width: '20%', textAlign: 'left' }}>Device</th>
      <th style={{ width: '20%', textAlign: 'left' }}>Points</th>
      <th style={{ width: '20%', textAlign: 'left' }}>Rendered at</th>
      <th style={{ width: '20%', textAlign: 'left' }}>Rendered pixels</th>
      <th style={{ width: '20%', textAlign: 'left' }}>Physical device size</th>
    </tr>
...
To keep the experience uniform across all the devices, the background color on a mobile app is the same as web i.e. Stone Lightest (#F7F7F7). Sheets and modals have a white background (#FFFFFF).
