  ...
  <Table
    ...
    data={[
      ...
      },
      {
        ...
        Value:
          'Height: 32px, Width: 40px Background: linear-gradient(90deg, rgba(247, 247, 247, 0) 0%, #F7F7F7 100%) or linear-gradient(90deg, rgba(255, 255, 255, 0) 0%, #FFFFFF 100%) "Background of the gradient must match the page background color."',
        Configurable: '❌',
      },
    ]}
    schema={[
