...
The fill trigger is recommended in moments where you need to capture the user’s attention.

<Preview name="components-select-styletype-filled--filled" />

#### Outlined

The outline trigger offers a subtle, modern look and is recommended best in data-dense environments.
