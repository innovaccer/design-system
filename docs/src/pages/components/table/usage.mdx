...
<Preview name='layout-table-resource-table--resource-table' />
...
<Preview name='layout-table-data-table--data-table' />
...
<Preview name='layout-table-table-as-option-list--table-as-option-list' />
...
<Preview name='layout-table-table-as-description-list--table-as-description-list' />
...
#### Standard table
<Preview name='layout-table-standard-table--standard-table' />

#### Compressed table
<Preview name='layout-table-compressed-table--compressed-table' />

#### Tight table
This size is typically suited for information-dense data tables
<Preview name='layout-table-tight-table--tight-table' />
...
<Preview name='layout-table-variants-nested-rows--nested-rows' />

##### With nested card
<Preview name='layout-table-nested-table-with-nested-cards--nested-table-with-nested-cards' />
...
![Content aligned centerally in a row](./images/table-7.png)
<Caption>Content aligned centerally in a row</Caption>
<br/>
...
<Preview name='layout-table-pinned-columns--pinned-columns' />
...
![When no item is selected](./images/table-14.png)
...
![When a few items are selected](./images/table-15.png)
...
![When all items on a page are selected](./images/table-16.png)
<Caption>When all items on a page are selected</Caption>
<br/>
...
![When all items across all pages are selected](./images/table-17.png)
<Caption>When all items across all pages are selected</Caption>
<br/>
