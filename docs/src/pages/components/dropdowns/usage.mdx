...
<Preview name="components-dropdown-deprecated-standard-dropdown--standard-dropdown" />
...
<Preview name="components-dropdown-deprecated-dropdown-as-menu--dropdown-as-menu" />
...
<Preview name="components-dropdown-deprecated-dropdown-with-icon--dropdown-with-icon" />

##### Inline Label

This variant comes with a label preceding the text and can be used at places where there is a space crunch.

<Preview name="components-dropdown-deprecated-label-inline--label-inline" />
...
<Preview name="components-dropdown-deprecated-dropdown-items-with-icon--dropdown-items-with-icon" />

##### With Sub Info

This variant comes with sub-info beneath the text.

<Preview name="components-dropdown-deprecated-dropdown-items-with-sub-info--dropdown-items-with-sub-info" />
...
<Preview name="components-dropdown-deprecated-dropdown-items-with-checkbox--dropdown-items-with-checkbox" />

### Sizes

Dropdowns come in **2 sizes** - small and regular.

<Preview name="components-dropdown-deprecated-variants-size--size" />
...
<Preview name="components-dropdown-deprecated-search-in-dropdown--search-in-dropdown" />
...
<Preview name="components-dropdown-deprecated-dropdown-options-less-than-50--dropdown-options-less-than-50" />
...
<Preview name="components-dropdown-deprecated-dropdown-options-more-than-50--dropdown-options-more-than-50" />
...
<Preview name="components-dropdown-deprecated-label-on-top--label-on-top" />
...
<Preview name="components-dropdown-deprecated-dropdown-with-help-text--dropdown-with-help-text" />
...
<Preview name="components-dropdown-deprecated-dropdown-with-action-buttons--dropdown-with-action-buttons" />
