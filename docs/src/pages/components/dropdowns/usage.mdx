...
<Preview name="inputs-dropdown-standard-dropdown--standard-dropdown" />
...
<Preview name="inputs-dropdown-dropdown-as-menu--dropdown-as-menu" />
...
<Preview name="inputs-dropdown-dropdown-with-icon--dropdown-with-icon" />

##### Inline label

This variant comes with a label preceding the text and can be used at places where there is a space crunch.

<Preview name="inputs-dropdown-label-inline--label-inline" />
...
<Preview name="inputs-dropdown-dropdown-items-with-icon--dropdown-items-with-icon" />

##### With sub info

This variant comes with sub-info beneath the text.

<Preview name="inputs-dropdown-dropdown-items-with-sub-info--dropdown-items-with-sub-info" />
...
<Preview name="inputs-dropdown-dropdown-items-with-checkbox--dropdown-items-with-checkbox" />

### Sizes

Dropdowns come in **2 sizes** - small and regular.

<Preview name="inputs-dropdown-variants-size--size" />
...
<Preview name="inputs-dropdown-search-in-dropdown--search-in-dropdown" />
...
<Preview name="inputs-dropdown-dropdown-options-less-than-50--dropdown-options-less-than-50" />
...
<Preview name="inputs-dropdown-dropdown-options-more-than-50--dropdown-options-more-than-50" />
...
<Preview name="inputs-dropdown-label-on-top--label-on-top" />
...
<Preview name="inputs-dropdown-dropdown-with-help-text--dropdown-with-help-text" />
...
<Preview name="inputs-dropdown-dropdown-with-action-buttons--dropdown-with-action-buttons" />
