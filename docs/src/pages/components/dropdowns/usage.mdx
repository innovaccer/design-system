...
<Preview name="dropdown-dropdown-as-menu"/>
...
<Preview name="dropdown-standard-dropdown"/>
...
<Preview name="dropdown-dropdown-items-with-icon"/>
...
<Preview name="dropdown-dropdown-items-with-checkbox"/>

### Sizes
Dropdowns come in **2 sizes** - regular and tiny.
<Preview name="dropdown-variants-size"/>
...
<Preview name="dropdown-search-in-dropdown"/>
...
<Preview name="dropdown-dropdown-options-less-than-50"/>
...
<Preview name="dropdown-dropdown-options-more-than-50"/>
...
<Preview name="dropdown-dropdown-with-caption"/>
...
<Preview name="dropdown-dropdown-with-action-buttons"/>
