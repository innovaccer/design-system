...
<Preview name='navigation-tabs-basic-tabs--basic-tabs'/>

#### Tabs with Count
This variation uses the Pill component to display the count along with the label.
<Preview name='navigation-tabs-tabs-with-count--tabs-with-count'/>
...
<Preview name='navigation-tabs-tabs-with-icon--tabs-with-icon'/>
