...
When a tab group has more tabs than can fit in the viewport, the extra tabs are moved into a menu next to the last visible tab. Selecting a tab from the menu replaces the last visible tab.  

**Note:** The active tab is always visible and never moved into the overflow menu.

<Preview name="components-tabs-overflow-overflow-tabs--overflow-tabs" />
