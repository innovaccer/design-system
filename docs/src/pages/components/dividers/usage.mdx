...
tabs: ['Usage', 'Code']
showMobile: true
keywords: ['Horizontal rule', 'Separator', 'Rule']
---
...
<Preview name="components-divider-horizontal-basic-divider-in-card--basic-divider-in-card"/>

#### Vertical
The vertical divider divides the content horizontally.
<Preview name="components-divider-vertical--vertical"/>
...
<Preview name="components-divider-indented--indented"/>
