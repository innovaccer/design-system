...
<Preview name="layout-divider-horizontal-basic-divider-in-card--basic-divider-in-card"/>

#### Vertical
The vertical divider divides the content horizontally.
<Preview name="layout-divider-vertical--vertical"/>
...
<Preview name="layout-divider-indented--indented"/>
