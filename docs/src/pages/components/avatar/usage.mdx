---
title: Avatar
description: An avatar is a thumbnail representation of a person or a group
tabs: ['Usage', 'Code']
showMobile: true
...
#### Round Avatar
The circular shape conveys approachability and subtly resembles a face. Use this avatar for an individual, an AI agent, or a bot.

![Shapes](./images/round-avatar.png)
<Caption>A round avatar</Caption>

#### Square Avatar
The angular shape communicates structure and formality. Use this avatar to represent a group, for example, a team, organization, user role, etc.
...
For bots, teams, and similar entities, use an icon or image instead of initials to clearly differentiate them from a person.
...
#### Use Icons for Bots, AI, and Groups

For bots, AI agents, and groups, avoid using initials to help users easily distinguish real people.

![Icons for Bots](./images/icons-for-bots.png)
<Caption>Avoid using initials for AI agents, bots, and groups</Caption>
