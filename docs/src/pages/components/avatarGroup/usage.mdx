...
**Note:** To display the additional entities that are not visible upfront, a popover with the full names of those entities is shown when you click over the numeric avatar.

![Popover displays hidden entities when the numeric avatar is activated](./images/count-more-than-three.png)
<Caption>Popover displays hidden entities when the numeric avatar is clicked</Caption>
