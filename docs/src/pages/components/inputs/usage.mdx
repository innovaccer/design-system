...
#### With icon
Basic inputs can have an icon on the left of text in the input box along with an optional icon on the right. This variant comes in 2 sizes i.e. regular and large as accommodating such icons is not possible in the tiny size.
...
### Sizes
Inputs come in **3 sizes** - regular, tiny and large with a few exceptions. Basic input with icon in the left, metric input and verification code input do not support the tiny size. Free text area comes in a single default size as it is resizable.
...
#### Verification code input behavior
<br/>
