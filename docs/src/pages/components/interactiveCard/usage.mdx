...
description: Interactive cards are used for actions like navigation and selection when options need to be descriptive, with a strong, captivating and balanced visual representation.
tabs: ['Usage',  'Code']
showMobile: true
...
Action cards facilitate navigation by offering clear descriptions and a design that is both engaging and balanced.
...
<Caption>Selection cards</Caption>
...
<table style={{width: "100%"}}>
  <tbody>
    ...
    <tr style={{verticalAlign: "top"}}>
      ...
      <tr style={{verticalAlign: "top"}}>
      <td>Spacing between title and description</td>
      <td>2 px </td>
    </tr>
  </tbody>
</table>
...
Interactive cards are used when you need to categorize your options using strong visual representation without making it overwhelming, while radio/checkbox is used for straightforward, simpler layouts.
