...
<Preview name="components-message-appearance-info--info" />

#### Inline Message
It is the less attention-grabbing counterpart and hence can be used in between components or patterns.
<Preview name="components-inlinemessage-appearance-info--info" />
...
![Inline messages](./images/sizes.png)
...
<Preview name="components-message-appearance-warning--warning" />
<Preview name="components-inlinemessage-appearance-warning--warning" />
...
<Preview name="components-message-appearance-alert--alert" />
<Preview name="components-inlinemessage-appearance-alert--alert" />

#### Success
The success variant is used when the inline message needs to notify the successful completion of a task or action.
<Preview name="components-message-appearance-success--success" />
<Preview name="components-inlinemessage-appearance-success--success" />
...
<table style={{width: "100%"}}>
 <tbody>
   ...
   <tr style={{verticalAlign: "top"}}>
      ...
      <td> 8 px, 8 px, 8 px, 8 px (Small) <br/> 12 px, 24 px, 16 px, 16 px (Regular)</td>
   </tr>
 </tbody>
</table>
<br/>
