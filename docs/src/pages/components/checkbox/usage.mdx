...
<Preview name="selection-checkbox-with-help-text--with-help-text" />

### Sizes

Checkbox comes in **two sizes** - small and regular.

<Preview name="selection-checkbox-variants-size--size" />
...
<Preview name="selection-checkbox-checkbox-group-vertical--vertical" />
...
<Preview name="selection-checkbox-checkbox-group-vertical--vertical" />
<br />
<Preview name="selection-checkbox-checkbox-group-horizontal--horizontal" />
...
<Preview name="selection-checkbox-checkbox-group-nested--nested" />
...
<Preview name="selection-checkbox-overflow-behavior--overflow-behavior" />
