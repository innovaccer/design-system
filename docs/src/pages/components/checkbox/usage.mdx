...
<Preview name="components-checkbox-checkbox-group-vertical--vertical" />
...
<Preview name="components-checkbox-checkbox-group-vertical--vertical" />
<br />
<Preview name="components-checkbox-checkbox-group-horizontal--horizontal" />
...
<Preview name="components-checkbox-checkbox-group-nested--nested" />
