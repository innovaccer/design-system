...
<Preview name="overlays-sidesheet-variants-dimension-regular--regular" />

#### Large

The large side sheet takes **10 columns** in the grid and starts from left side of the screen.

<Preview name="overlays-sidesheet-variants-dimension-large--large" />
...
<Caption> Default vs Large side sheet </Caption>
...
<Caption> Actions appear in the bottom </Caption>
...
<Caption> Actions appear just beneath the content </Caption>
...
<Caption> Dividers are hidden </Caption>
...
<Caption> Dividers are visible </Caption>
...
<Preview name="overlays-sidesheet-two-steps--two-steps" />
