...
<Caption> States of inline editable select</Caption>
...
![Structure of Inline editable dropdown](./images/basic-inputs-structures.png)
...
<table style={{width: "100%"}}>
  <tbody>
    ...
    <tr style={{verticalAlign: "top"}}>
      ...
      <td>
        <ul>
          <li>12 px <em>(Regular)</em></li>
          <li>8 px <em>(Small)</em></li>
        </ul>
      </td>
    </tr>
    <tr style={{verticalAlign: "top"}}>
...
#### Input With Chips
![Structure of Inline editable dropdown](./images/input-with-chips-structure.png)
