...
<Preview name='navigation-horizontalnav-variants-with-icon--with-icon'/>
...
<Preview name='navigation-horizontalnav-variants-with-count--with-count'/>
...
<Preview name='navigation-horizontalnav-left-aligned--left-aligned'/>
