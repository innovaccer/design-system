...
<Preview name='components-horizontalnav-variants-with-icon--with-icon'/>
...
<Preview name='components-horizontalnav-variants-with-count--with-count'/>
...
<Preview name='components-horizontalnav-left-aligned--left-aligned'/>
