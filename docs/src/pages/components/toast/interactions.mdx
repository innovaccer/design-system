import toast2 from './images/toast-2.gif'
import toast3 from './images/toast-3.gif'
import toast5 from './images/toast-5.gif'

### Showing the toast

*Interaction has been slowed down for display purpose only*

<img src={toast2} width='100%' height='auto'/>
<br/>
<br/>
...
<img src={toast3} width='100%' height='auto'/>
<br/>
<br/>
...
<img src={toast5} width='100%' height='auto'/>
<br/>
<br/>
