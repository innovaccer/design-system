...
<Preview name='actions-button-appearance-basic--basic' />
...
<Preview name='actions-button-appearance-alert--alert' />

#### Transparent button
Transparent button indicates actions that are less important or less frequent.
<Preview name='actions-button-appearance-transparent--transparent' />
...
<Preview name='actions-button-expanded-button--expanded-button' />
...
##### Icon in left
<Preview name='actions-button-icon-icon-left--icon-left' />

##### Icon in right
<Preview name='actions-button-icon-icon-right--icon-right' />
...
<Preview name='actions-button-icon-icon-button--icon-button' />
<br/>
...
<Preview name='actions-button-appearance-all--all' />
<br/>

### Sizes

Buttons come in **3 sizes** - small, regular and large.
<Preview name='actions-button-size--size' />
<br/>
...
<Preview name='actions-button-state-primary--primary' />
<br/>
...
<Preview name='actions-button-loader-in-button--loader-in-button' />
...
<Preview name='actions-button-split-button--split-button' />
...
**Basic button group**
<Preview name='actions-button-label-button-group--label-button-group' />

**Icon button group**
<Preview name='actions-button-icon-icon-button-group--icon-button-group' />