...
<Preview name='components-button-appearance-basic--basic' />
...
<Preview name='components-button-appearance-alert--alert' />

#### Transparent button
Transparent button indicates actions that are less important or less frequent.
<Preview name='components-button-appearance-transparent--transparent' />
...
##### Icon in left
<Preview name='components-button-icon-icon-left--icon-left' />

##### Icon in right
<Preview name='components-button-icon-icon-right--icon-right' />
...
<Preview name='components-button-icon-icon-button--icon-button' />
<br/>
...
<Preview name='components-button-appearance-all--all' />
<br/>

### Sizes

Buttons come in **3 sizes** - small, regular and large.
<Preview name='components-button-size--size' />
<br/>
...
<Preview name='components-button-state-primary--primary' />
<br/>
...
**Icon button group**
<Preview name='components-button-icon-icon-button-group--icon-button-group' />