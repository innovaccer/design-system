...
<Preview name="overlays-fullscreenmodal-variants-dimension-medium--medium" />
...
- To indicate that the content can be scrolled, use a scrollbar and show the dividers in both the header and the footer component. This helps to convey that the header and the footer are fixed.
  <Preview name="overlays-modal-scrolling--scrolling" />
...
<Preview name="overlays-fullscreenmodal-two-steps-workflow--two-steps-workflow" />
...
<Preview name="overlays-fullscreenmodal-scrolling--scrolling" />
