...
<Preview name='indicators-statushint-variants-info--info'/>

#### Warning 

<Preview name='indicators-statushint-variants-warning--warning'/>

#### Success

<Preview name='indicators-statushint-variants-success--success'/>

#### Alert

<Preview name='indicators-statushint-variants-alert--alert'/>

#### Default

<Preview name='indicators-statushint-variants-default-status-hint--default-status-hint'/>
