...
<Preview name='loaders-progressbar-fifty-percent--fifty-percent'/>

#### Progress Ring

Goes from 0 to 100 along the circumference. It comes in 2 sizes -

<Preview name='loaders-progressring-size--size'/>
...
<Preview name='loaders-spinner-size--size'/>
...
<Preview name='loaders-placeholder-skeleton-loaders--skeleton-loaders'/>
<br/>
