...
<Preview name='components-slider-types-uncontrolled-slider--uncontrolled-slider'/>

#### Range slider

Range slider is used if the user wants to select a range instead of a single value.

<Preview name='components-rangeslider-types-uncontrolled-slider--uncontrolled-slider'/>
...
<Preview name='components-slider-variants-discrete-slider--discrete-slider'/>
