...
<Preview name='selection-slider-types-uncontrolled-slider--uncontrolled-slider'/>

#### Range slider

Range slider is used if the user wants to select a range instead of a single value.

<Preview name='selection-rangeslider-types-uncontrolled-slider--uncontrolled-slider'/>
...
<Preview name='selection-slider-variants-discrete-slider--discrete-slider'/>
...
<Preview name='selection-slider-variants-free-slider--free-slider'/>
