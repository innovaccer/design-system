import stepper7 from './images/stepper-7.gif'
import stepper8 from './images/stepper-8.gif'

### Moving to next step

<img src={stepper7} width='100%' height='auto'/>
...
<img src={stepper8} width='100%' height='auto'/>
