...
Personalized content can be added by pressing “@” on the keyboard which triggers a dropdown with custom options. Any option then selected will be inserted which can be cleared if needed.

![Personalized content](./images/mention.png)
<Caption>Personalized content</Caption>
