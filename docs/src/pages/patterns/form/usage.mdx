...
![A multi step form](./images/form-4.png)
...
![Inline arrangement of form fields](./images/form-7.png)
...
![Form in a modal](./images/form-8.png)
...
![When content takes more than 75% of the height](./images/form-9.png)
...
![When content takes less than 75% of the height](./images/form-10.png)
...
Form fields can be marked as [optional or required](/components/inputs/usage/#required-vs-optional) depending upon the context. To avoid unnecessary clutter, mark only the minority fields as optional or required.
...
![Default status of auto-save form](./images/form-13.png)
...
![Saving status of auto-save form](./images/form-14.png)
...
![Saved status of auto-save form](./images/form-15.png)
...
![Error status of auto-save form](./images/form-16.png)
