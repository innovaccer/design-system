...
describe('Link component', () => {
  ...
  it('renders default props', () => {
    const { getByTestId } = render(<Link>Click on Link</Link>);
    expect(getByTestId('DesignSystem-Link')).toHaveClass('Mds-Link--regular');
    expect(getByTestId('DesignSystem-Link')).toHaveClass('Mds-Link--default');
  });
  ...
  describe('Link Component with overwrite class', () => {
    it('overwrite Link class', () => {
      ...
      expect(getByTestId('DesignSystem-Link')).toHaveClass('Mds-Link LinkClass');
    });
  });
  ...
  describe('Link component with prop:appearance', () => {
    appearances.forEach((appearance) => {
      it(`should have the Link--${appearance} class when appearance=${appearance} `, () => {
        ...
        expect(getByTestId('DesignSystem-Link')).toHaveClass(`Mds-Link--${appearance}`);
      });
    });
  });
  ...
  describe('Link component with prop:size', () => {
    sizes.forEach((size) => {
      it(`should have the Link--${size} class when appearance=${size} `, () => {
        ...
        expect(getByTestId('DesignSystem-Link')).toHaveClass(`Mds-Link--${size}`);
      });
    });
  });
  ...
  describe('Link component with prop:disabled', () => {
    it('link should be disabled', () => {
      ...
      expect(getByTestId('DesignSystem-Link')).toHaveClass('Mds-Link--disabled');
    });
  });
});
