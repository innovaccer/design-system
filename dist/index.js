...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Avatar = function Avatar(props) {
      ...
      var classes = classNames__default["default"]((_a = {}, _a["Next-Avatar"] = true, _a["Next-Avatar--".concat(size)] = size, _a["Next-Avatar--".concat(avatarAppearance)] = avatarAppearance, _a['Next-Avatar--disabled'] = !text || !(image === null || image === void 0 ? void 0 : image.src) || !icon, _a['Next-overflow-hidden'] = !text, _a), className);
      var contentClass = classNames__default["default"]((_b = {}, _b["Next-Avatar-content--".concat(size)] = size, _b["Next-Avatar-content--".concat(avatarAppearance)] = avatarAppearance, _b));
      var iconClass = classNames__default["default"]((_c = {}, _c["Next-Avatar-content--".concat(avatarAppearance)] = avatarAppearance, _c));
      var imageDimensions = {
    ...
    var Text = function Text(props) {
      ...
      var classes = classNames__default["default"]((_a = {}, _a["Next-Text"] = true, _a["Next-Text--".concat(appearance)] = appearance, _a["Next-Text--".concat(weight)] = weight, _a["Next-Text--".concat(size)] = size, _a['Next-Text--small'] = size === 'small' || small, _a), className);
    ...
    var Pills = function Pills(props) {
      ...
      var baseProps = extractBaseProps(props);
      var classes = classNames__default["default"]((_a = {}, _a["Next-Pills"] = true, _a["Next-Badge--".concat(appearance)] = appearance && !subtle, _a["Next-Badge--subtle-".concat(appearance)] = subtle, _a), className);
      return /*#__PURE__*/React__namespace.createElement("span", __assign({
        role: "status",
    ...
    var Badge = function Badge(props) {
      ...
      var appearance = props.appearance,
          ...
          ariaLabel = props.ariaLabel;
      var baseProps = extractBaseProps(props);
      var classes = classNames__default["default"]((_a = {}, _a["Next-Badge"] = true, _a["Next-Badge--".concat(appearance)] = appearance && !subtle, _a["Next-Badge--subtle-".concat(appearance)] = subtle, _a), className);
      return /*#__PURE__*/React__namespace.createElement("span", __assign({
        role: "status",
        "aria-label": ariaLabel,
    ...
    var ButtonElement = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
      ...
      var buttonClass = classNames__default["default"]((_a = {}, _a['Next-Button'] = true, _a['Next-Button--expanded'] = expanded, _a["Next-Button--".concat(size)] = size, _a["Next-Button--".concat(size, "Square")] = !children, _a["Next-Button--".concat(appearance)] = appearance, _a['Next-Button--selected'] = selected && (appearance === 'basic' || appearance === 'transparent'), _a["Next-Button--iconAlign-".concat(iconAlignment)] = children && iconAlignment, _a["".concat(className)] = className, _a));
      var iconClass = classNames__default["default"]((_b = {}, _b['Next-Button-icon'] = true, _b["Next-Button-icon--".concat(iconAlignment)] = children && iconAlignment, _b));
    ...
    var Popover = function Popover(props) {
      ...
      var classes = classNames__default["default"]((_a = {}, _a['Next-Popover--dark'] = dark, _a["".concat(className)] = className, _a), "Next-Popover");
      var positionOffset = {
        'auto-start': 'top left',
        auto: 'top',
        'auto-end': 'top right',
