    ...
    ***************************************************************************** */
    ...
    var Checkbox = /*#__PURE__*/React__namespace.forwardRef(function (props, forwardedRef) {
      ...
      var _f = props.size,
          ...
          _h = props.id,
          id = _h === void 0 ? name + "-" + label + "-" + uidGenerator() : _h,
      ...
      var _j = React__namespace.useState(checkedProp === undefined ? defaultChecked : checkedProp),
          checked = _j[0],
          setChecked = _j[1];
    ...
    var DropdownList = function DropdownList(props) {
      ...
      var SelectAllClass = classNames__default["default"]((_c = {}, _c['Option-checkbox--active'] = cursor === 0, _c['Option-checkboxWrapper'] = true, _c['Option-checkbox'] = true, _c));
    ...
    var Calendar = function (_super) {
      ...
      Calendar.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if (((_a = prevProps.date) === null || _a === void 0 ? void 0 : _a.getTime()) !== ((_b = this.props.date) === null || _b === void 0 ? void 0 : _b.getTime())) {
          var _o = getDateInfo(this.props.date),
              year = _o.year,
              month = _o.month,
              date = _o.date;
        ...
        if (((_c = prevProps.startDate) === null || _c === void 0 ? void 0 : _c.getTime()) !== ((_d = this.props.startDate) === null || _d === void 0 ? void 0 : _d.getTime())) {
        ...
        if (((_e = prevProps.endDate) === null || _e === void 0 ? void 0 : _e.getTime()) !== ((_f = this.props.endDate) === null || _f === void 0 ? void 0 : _f.getTime())) {
        ...
        if (((_g = prevState.currDate) === null || _g === void 0 ? void 0 : _g.getTime()) !== ((_h = this.state.currDate) === null || _h === void 0 ? void 0 : _h.getTime())) {
          var _p = this.props,
              rangePicker = _p.rangePicker,
              onDateChange = _p.onDateChange;
          var _q = this.state,
              currDate = _q.currDate,
              startDate = _q.startDate,
              endDate = _q.endDate;
        ...
        if (((_j = prevState.startDate) === null || _j === void 0 ? void 0 : _j.getTime()) !== ((_k = this.state.startDate) === null || _k === void 0 ? void 0 : _k.getTime()) || ((_l = prevState.endDate) === null || _l === void 0 ? void 0 : _l.getTime()) !== ((_m = this.state.endDate) === null || _m === void 0 ? void 0 : _m.getTime())) {
    ...
    var GenericChip = function GenericChip(props) {
      ...
      var iconAppearance = function iconAppearance(align) {
        ...
        return classNames__default["default"]((_a = {}, _a['disabled'] = disabled && !selected, _a['primary'] = !disabled && selected, _a['primary_lighter'] = disabled && selected, _a['subtle'] = !disabled && !selected && align === 'right', _a['inverse'] = !disabled && !selected && align === 'left', _a));
      };

      var textAppearance = classNames__default["default"]((_a = {}, _a['disabled'] = disabled && !selected, _a['link'] = selected, _a['default'] = !disabled && !selected, _a));
      return /*#__PURE__*/React__namespace.createElement("div", __assign({
    ...
    var MetricInput = /*#__PURE__*/React__namespace.forwardRef(function (props, forwardedRef) {
      ...
      var _f = React__namespace.useState(valueProp || defaultValue),
          value = _f[0],
          setValue = _f[1];
    ...
    var PopperWrapper = function (_super) {
      ...
      PopperWrapper.prototype.getPopperChildren = function (_a) {
        ...
        if (!animationClass) {
          ...
          classes = classNames__default["default"]((_b = {}, _b["" + animationClass.open] = this.state.isOpen, _b["" + animationClass.close] = this.state.showClosingAnimation, _b), children.props.className);
        }
    ...
    var Tabs = function Tabs(props) {
      ...
      var _g = React__namespace.useState(props.activeIndex && props.activeIndex < totalTabs ? props.activeIndex : 0),
          activeIndex = _g[0],
          setActiveTab = _g[1];
      ...
      var iconClass = function iconClass(disabled) {
        ...
        return classNames__default["default"]((_a = {}, _a["DismissibleTab-icon--right"] = true, _a['cursor-pointer'] = !disabled, _a));
      };
      ...
      if ('props' in tabs[activeIndex]) {
        ...
        activeTabClass = (_d = activeTab.props) === null || _d === void 0 ? void 0 : _d.className;
      } else {
        activeTab = tabs[activeIndex];
      ...
      var renderTab = function renderTab(tab, index) {
        var _a = tab,
            ...
            label = _b === void 0 ? '' : _b,
            disabled = _a.disabled,
            isDismissible = _a.isDismissible,
            _c = _a.onDismiss,
            onDismiss = _c === void 0 ? function () {} : _c;
      ...
      return /*#__PURE__*/React__namespace.createElement("div", __assign({
        ...
        className: headerClass
      }, renderTabs, inlineComponent), children && ((_e = tabs[activeIndex].props) === null || _e === void 0 ? void 0 : _e.disabled) ? /*#__PURE__*/React__namespace.createElement("div", {
