...
var Text = function Text(props) {
  ...
  var classes = classnames((_classNames = {}, _defineProperty(_classNames, "Next-Text", true), _defineProperty(_classNames, "Next-Text--".concat(appearance), appearance), _defineProperty(_classNames, "Next-Text--".concat(weight), weight), _defineProperty(_classNames, "Next-Text--".concat(size), size), _defineProperty(_classNames, 'Next-Text--small', size === 'small' || small), _classNames), className);
...
var _excluded$2 = ["children", "tooltip"];
...
var _excluded$1 = ["children", "className", "onOutsideClick"];
...
export { Avatar, Badge, Button, Icon, OutsideClick, Paragraph, Pills, Popover, Spinner, Text, Tooltip, index$2 as Utils, version };
