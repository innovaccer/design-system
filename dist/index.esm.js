...
var _excluded$9 = ["size", "className", "appearance", "icon", "text", "tooltip", "image"];
var Avatar = function Avatar(props) {
  ...
  var size = props.size,
      ...
      image = props.image,
      rest = _objectWithoutProperties(props, _excluded$9); // To check if the image src loads a valid image
  ...
  var classes = classnames((_classNames = {}, _defineProperty(_classNames, "Mds-Avatar", true), _defineProperty(_classNames, "Mds-Avatar--".concat(size), size), _defineProperty(_classNames, "Mds-Avatar--".concat(avatarAppearance), avatarAppearance), _defineProperty(_classNames, 'Mds-Avatar--disabled', !text || !(image !== null && image !== void 0 && image.src) || !icon), _defineProperty(_classNames, 'Mds-overflow-hidden', !text), _classNames), className);
  var contentClass = classnames((_classNames2 = {}, _defineProperty(_classNames2, "Mds-Avatar-content--".concat(size), size), _defineProperty(_classNames2, "Mds-Avatar-content--".concat(avatarAppearance), avatarAppearance), _classNames2));
  var iconClass = classnames(_defineProperty({}, "Mds-Avatar-content--".concat(avatarAppearance), avatarAppearance));
  var imageDimensions = {
...
var _excluded$8 = ["children", "componentType", "className"];
...
var _excluded$7 = ["appearance", "size", "children", "weight", "className"];
var Text = function Text(props) {
  ...
  var classes = classnames((_classNames = {}, _defineProperty(_classNames, "Mds-Text", true), _defineProperty(_classNames, "Mds-Text--".concat(appearance), appearance), _defineProperty(_classNames, "Mds-Text--".concat(weight), weight), _defineProperty(_classNames, "Mds-Text--".concat(size), size), _classNames), className);
...
var _excluded$6 = ["onClick", "onKeyDown", "role"];
var allowed = {
...
var Pills = function Pills(props) {
  ...
  var baseProps = extractBaseProps(props);
  var classes = classnames((_classNames = {}, _defineProperty(_classNames, "Mds-Pills", true), _defineProperty(_classNames, "Mds-Badge--".concat(appearance), appearance && !subtle), _defineProperty(_classNames, "Mds-Badge--subtle-".concat(appearance), subtle), _classNames), className);
  return /*#__PURE__*/React.createElement("span", _extends$1({
    role: "status",
...
var Badge = function Badge(props) {
  ...
  var appearance = props.appearance,
      ...
      ariaLabel = props.ariaLabel;
  var baseProps = extractBaseProps(props);
  var classes = classnames((_classNames = {}, _defineProperty(_classNames, "Mds-Badge", true), _defineProperty(_classNames, "Mds-Badge--".concat(appearance), appearance && !subtle), _defineProperty(_classNames, "Mds-Badge--subtle-".concat(appearance), subtle), _classNames), className);
  return /*#__PURE__*/React.createElement("span", _extends$1({
    role: "status",
    "aria-label": ariaLabel,
...
var _excluded$5 = ["size", "appearance", "tabIndex", "type", "children", "iconOptions", "expanded", "selected", "loading", "disabled", "className"];
var sizeMapping = {
  tiny: 12,
  regular: 16,
  large: 20
...
var ButtonElement = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var buttonClass = classnames((_classNames = {}, _defineProperty(_classNames, 'Mds-Button', true), _defineProperty(_classNames, 'Mds-Button--expanded', expanded), _defineProperty(_classNames, "Mds-Button--".concat(size), size), _defineProperty(_classNames, "Mds-Button--".concat(size, "Square"), !children), _defineProperty(_classNames, "Mds-Button--".concat(appearance), appearance), _defineProperty(_classNames, 'Mds-Button--selected', selected && (appearance === 'basic' || appearance === 'transparent')), _defineProperty(_classNames, "Mds-Button--iconAlign-".concat(iconAlignment), children && iconAlignment), _defineProperty(_classNames, "".concat(className), className), _classNames));
  var iconClass = classnames((_classNames2 = {}, _defineProperty(_classNames2, 'Mds-Button-icon', true), _defineProperty(_classNames2, "Mds-Button-icon--".concat(iconAlignment), children && iconAlignment), _classNames2));
...
var Button = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  return iconOptions !== null && iconOptions !== void 0 && iconOptions.name && iconOptions !== null && iconOptions !== void 0 && iconOptions.tooltip && !children ? /*#__PURE__*/React.createElement(Tooltip, {
    text: iconOptions === null || iconOptions === void 0 ? void 0 : iconOptions.tooltip
...
var Popover = function Popover(props) {
            ...
            case 0:
              if (!animationClass) {
                ...
                if (maxHeight) {
                  ...
                  if (open) {
                    setAnimation("popper-open-".concat(animationId, " 120ms cubic-bezier(0, 0, 0.38, 0.9), popper-fade-in 120ms"));
                  } else {
                    setAnimation("popper-close-".concat(animationId, " 120ms cubic-bezier(0.2, 0, 1, 0.9), MdsFadeOut 120ms "));
                  }
  ...
  }), useDismiss(context, _objectSpread2({}, dismissOptions)), useFocus(context, {
    enabled: false
  })];
  ...
  var classes = classnames((_classNames = {}, _defineProperty(_classNames, 'Mds-Popover--dark', dark), _defineProperty(_classNames, "".concat(animation, "-").concat(tooltipPositionValue[currentPlacement]), animationClass && animation), _defineProperty(_classNames, "".concat(className), className), _classNames), "Mds-Popover");
  var popover = /*#__PURE__*/React.createElement(FloatingFocusManager, {
    ...
    onAnimationEnd: !animationClass ? function () {
  ...
  if (!hoverable) {
    if (open) {
      ...
      onClick = referenceProps === null || referenceProps === void 0 ? void 0 : referenceProps.onClick;
    }
  }
...
var _excluded$4 = ["children", "text", "placement"];
...
var _excluded$3 = ["children", "className", "onOutsideClick"];
...
var _excluded = ["children", "className", "appearance", "size", "disabled"];
var Link = function Link(props) {
  ...
  var classes = classnames((_classNames = {}, _defineProperty(_classNames, 'Mds-Link', true), _defineProperty(_classNames, 'Mds-Link--disabled', disabled), _defineProperty(_classNames, "Mds-Link--".concat(size), size), _defineProperty(_classNames, "Mds-Link--".concat(appearance), appearance), _classNames), className);
  return /*#__PURE__*/React.createElement(GenericText, _extends$1({
    componentType: "a",
    className: classes,
