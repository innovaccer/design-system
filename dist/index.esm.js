...
var _excluded$6 = ["size", "className", "appearance", "icon", "text", "tooltip", "image"];
var Avatar = function Avatar(props) {
  ...
  var size = props.size,
      ...
      image = props.image,
      rest = _objectWithoutProperties(props, _excluded$6); // To check if the image src loads a valid image
...
var _excluded$5 = ["children", "componentType", "className"];
...
var _excluded$4 = ["appearance", "size", "children", "weight", "small", "className"];
...
var _excluded$3 = ["onClick", "onKeyDown", "role"];
var allowed = {
...
var _excluded$2 = ["size", "appearance", "tabIndex", "type", "children", "iconOptions", "expanded", "selected", "loading", "disabled", "className"];
var sizeMapping = {
  tiny: 12,
  regular: 16,
  large: 20
...
var ButtonElement = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var buttonClass = classnames((_classNames = {}, _defineProperty(_classNames, 'Button', true), _defineProperty(_classNames, 'Button--expanded', expanded), _defineProperty(_classNames, "Button--".concat(size), size), _defineProperty(_classNames, "Button--".concat(size, "Square"), !children), _defineProperty(_classNames, "Button--".concat(appearance), appearance), _defineProperty(_classNames, 'Button--selected', selected && (appearance === 'basic' || appearance === 'transparent')), _defineProperty(_classNames, "Button--iconAlign-".concat(iconAlignment), children && iconAlignment), _defineProperty(_classNames, "".concat(className), className), _classNames));
  var iconClass = classnames((_classNames2 = {}, _defineProperty(_classNames2, 'Button-icon', true), _defineProperty(_classNames2, "Button-icon--".concat(iconAlignment), children && iconAlignment), _classNames2));
...
var Popover = function Popover(props) {
  ...
  var classes = classnames((_classNames = {}, _defineProperty(_classNames, 'Popover--dark', dark), _defineProperty(_classNames, "".concat(className), className), _classNames), "Popover");
  var positionOffset = {
    'auto-start': 'top left',
    auto: 'top',
    'auto-end': 'top right',
...
export { Avatar, Badge, Button, Icon, OutsideClick, Pills, Popover, Spinner, Text, Tooltip, index$2 as Utils, version };
