...
export declare type FindFocusableCalendarCellOptions = {
    preferredAriaLabel?: string;
    preferredSelectedIndex?: 'first' | 'last';
};
export declare const findFocusableCalendarCell: (root: HTMLElement, options?: FindFocusableCalendarCellOptions) => HTMLElement | null;
