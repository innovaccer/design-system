...
export declare class Calendar extends React.Component<CalendarProps, CalendarState> {
    ...
    selectMonth: (month: number, disabled?: boolean) => () => void;
    ...
    handleDateCellKeyDown: (ev: React.KeyboardEvent, index: number, _row: number, _col: number, _noOfRows: number, date: number, prevMonthDayRange: number, dayRange: number, inRangeError: boolean, rangePicker: boolean, startDate?: Date, endDate?: Date) => void;
    ...
    setCalendarWrapperRef: (node: HTMLDivElement | null) => void;
