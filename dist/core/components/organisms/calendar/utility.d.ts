import { DateObject, Day } from './types';
...
export declare const convertToDate: (d?: string | number | DateObject | Date | undefined, format?: string | undefined, validator?: Validator | undefined) => Date | undefined;
export declare const compareDecade: (d: string | number | Date | undefined, operator: Operator, currDecade: number) => boolean;
export declare const compareDate: (d: string | number | Date | undefined, operator: Operator, currYear: number, currMonth?: number | undefined, currDate?: number | undefined) => boolean;
