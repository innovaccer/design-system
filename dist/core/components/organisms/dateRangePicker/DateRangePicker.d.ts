...
export declare class DateRangePicker extends React.Component<DateRangePickerProps, DateRangePickerState> {
    ...
    onInputKeyDown: (input: "start" | "end" | "single") => (e: React.KeyboardEvent<HTMLInputElement>) => void;
    ...
    onRangeChangeHandler: (sDate?: Date, eDate?: Date) => void;
    onToggleHandler: (o: boolean, type?: string) => void;
