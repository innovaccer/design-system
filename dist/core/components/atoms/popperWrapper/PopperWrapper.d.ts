...
export declare function usePopover({ initialOpen, placement, modal, open: controlledOpen, onOpenChange: setControlledOpen, closeOnEscape, closeOnScroll, closeOnBackdropClick, triggerMethod, openDelay, offset: offsetNumber, disabled, hideOnReferenceEscape, animationClass, portalRoot, appendToBody, triggerCoordinates, }?: PopperWrapperProps): {
