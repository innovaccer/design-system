...
export declare const getTextColor: (isActive: boolean, disabled?: boolean | undefined) => "inverse" | "primary-dark" | "inverse-lightest";
export declare const getIconAppearance: (isActive: boolean, disabled?: boolean | undefined) => "default" | "disabled" | "info";
export declare const getHorizontalIconAppearance: (isActive: boolean, disabled?: boolean | undefined) => "default" | "disabled" | "primary_dark";
