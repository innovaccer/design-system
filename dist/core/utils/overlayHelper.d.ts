...
export declare const getAllFocusableElements: (container: HTMLElement, roleHint?: string) => HTMLElement[];
export declare const getNestedOverlayElements: (ownOverlayEl: HTMLElement | null, container: HTMLElement) => HTMLElement[];
export declare const handleFocusTrapKeyDown: (event: KeyboardEvent, container: HTMLElement, staticFocusTarget?: HTMLElement | null, nestedOverlays?: HTMLElement[]) => boolean;
...
export declare const restoreFocusToElementIfConnected: (element: HTMLElement | null | undefined, closingOverlay?: HTMLElement | null) => void;
export {};
