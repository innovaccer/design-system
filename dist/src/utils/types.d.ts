...
export declare type MakeOptional<T extends object, K extends keyof any> = Omit<T, K> & {
...
export declare type TextFormatterProps = ChildProps & BaseProps & BaseHtmlProps<HTMLElement>;
